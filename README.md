...
| :--- | :--- | :--- | :--- | :--- |
| **2026** | **UM IDP x MHNexus CPG LLM Agentic RAG & Knowledge Graph** | [**RAG**][(https://github.com/itznotpk/CPG-LLM-Agentic-RAG-Knowledge-Graph) | `Agentic RAG` `Pydantic AI` `Neo4j & Graphiti` `Neon` `PostgreSQL & Pgvector` |      |
